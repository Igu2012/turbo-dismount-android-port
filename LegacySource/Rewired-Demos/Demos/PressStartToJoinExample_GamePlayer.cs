...
namespace Rewired.Demos
{
	...
	public class PressStartToJoinExample_GamePlayer : MonoBehaviour
	{
		...
		private Player player
		{
			get
			{
				return PressStartToJoinExample_Assigner.GetRewiredPlayer(gamePlayerId);
			}
		}
		...
		private void ProcessInput()
		{
			...
			if (fire)
			{
				GameObject gameObject = (GameObject)Object.Instantiate(bulletPrefab, base.transform.position + base.transform.right, base.transform.rotation);
